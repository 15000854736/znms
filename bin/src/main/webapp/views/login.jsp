			...
			<form:form class="form-signin" action="login" method="post" modelAttribute="loginBean" id="login_form">
				<div class="login_box"> 
					...
					<div class="login_password">
						<i></i>
						<form:input path="password" type="password" value="密码" class="input_col icon_b" id="password" onfocus="if (value =='密码'){value ='';this.type = 'text'}" onblur="if (value ==''){value='密码';this.type = 'text'}"
								onchange="this.type = 'password'" style="color:#555;"/>
					</div>
