...
<script>
	...
	var flowDirectionSource = [{text:"流入",value:1},{text:"流出",value:2}];
...
<body>
		...
		<div class="znms_box">
			<p class="page_top_menu">系统管理&gt; <span class="bold">阀值管理&gt;</span> <span class="bold">添加阀值</span></p>
		<!-- 头部菜单 end-->
		<form:form id="thresholdValueForm" action="${pageContext.request.contextPath }/thresholdValue/mergeDo" method="post" modelAttribute="thresholdValue">
				...
				<tr>
			        <td class="nms_data_right">
					  ...
					  <td>
						...
						<span id='warningHighLowError' class="errMsg">高阀值必须大于低阀值</span>
						<span id="warningHighError2" class="errMsg">最多只能有2位小数</span>
					  </td>
					  <td class="nms_data_right">
					  	<span class=" bold">低阀值</span>
					  </td>          
					  <td>
		  ...
		  <div class="mod_buttom_box">
		  	...
		  	<button type="button" class="btn btn-primary btn-xs" onclick="mergeDo();" id="submitButton">保存</button>
		  </div>
		</form:form>
