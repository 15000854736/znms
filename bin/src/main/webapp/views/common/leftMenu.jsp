...
<script>
		...
		function clickSecondGradeMenu(obj){
			...
			$(".nms_icon_f").addClass("nms_icon_hov");
			$(".nms_menu_b li").each(function(){
				$(this).removeClass("nms_menu_bhov");
			});
...
<div class="nms_left">
  ...
  <div class="nms_menu_box">
    <ul  class="nms_menu_a" >
      ...
      <li id="first5" class="nms_icon_d firstGrade" onclick="clickFirstGradeMenu(this);"><i></i><a href="${pageContext.request.contextPath}/thresholdValueAlarm">阀值告警</a></li>
      ...
      <ul class="nms_menu_b" style="display:none" id="settingUl">
        ...
        <li id="second73" onclick='clickSecondGradeMenu(this);'><i></i><a href="${pageContext.request.contextPath}/host">主机</a></li>
        ...
        <li id="second76" onclick='clickSecondGradeMenu(this);'><i></i><a href="${pageContext.request.contextPath}/systemLogDeleteRule">日志删除规则</a></li>
        ...
        <li id="second79" onclick='clickSecondGradeMenu(this);'><i></i><a href="${pageContext.request.contextPath}/thresholdValue">阀值</a></li>
        <li id="second710" onclick='clickSecondGradeMenu(this);'><i></i><a href="${pageContext.request.contextPath}/apInformation">AP信息</a></li>
      </ul>
    </ul>
  </div>
</div>
