					...
					a.jqx._jqxDropDownList.prototype,
					{
						...
						render : function() {
							...
							if (a.jqx._jqxListBox == null
								...
								throw new Error(
										"jqxDropDownList: Missing reference to jqxlistbox.js.")
							}
							if (q.host.attr("tabindex")) {
								q.host
										.attr("tabindex", q.host
												.attr("tabindex"));
							...
							q.dropdownlistContent
									.addClass(q
											.toThemeProperty("jqx-dropdownlist-content jqx-disableselect"));
							if (q.rtl) {
								q.dropdownlistContent
										.addClass(q
												.toThemeProperty("jqx-rtl jqx-dropdownlist-content-rtl"))
							}
							q.addHandler(q.dropdownlistWrapper, "selectstart",
									function() {
										return false
									});
							q.dropdownlistWrapper[0].id = "dropdownlistWrapper"
									+ q.element.id;
							q.dropdownlistArrow[0].id = "dropdownlistArrow"
									+ q.element.id;
							q.dropdownlistContent[0].id = "dropdownlistContent"
									+ q.element.id;
							q._addInput();
							...
							try {
								...
								var b = a("<div style='overflow: hidden; background-color: transparent; border: none; position: absolute; z-index: 999999999;' id='listBox"
										+ q.id
										+ "'><div id='innerListBox"
										+ q.id + "'></div></div>");
								b.hide();
								...
								q.container = b;
								q.listBoxContainer = a(a.find("#innerListBox"
										+ q.id));
								var d = q.width;
								...
								q.listBoxContainer
										.jqxListBox({
											...
											theme : q.theme,
											rendered : function() {
												if (q.selectedIndex != q.listBoxContainer
								...
								q.listBox = a.data(q.listBoxContainer[0],
										"jqxListBox").instance;
							...
							q.propertyChangeMap.disabled = function(e, t, s, u) {
								if (u) {
									...
									e.dropdownlistArrow.children().css("display", "none");
								} else {
									e.host
											.removeClass(q
													.toThemeProperty("jqx-dropdownlist-state-disabled"));
									...
									e.dropdownlistContent
											.removeClass(q
													.toThemeProperty("jqx-dropdownlist-content-disabled"));
									e.dropdownlistArrow.children().css("display", "block");
								}
							...
							if (a.jqx.browser.msie && a.jqx.browser.version < 8) {
								if (q.host.parents(".jqx-window").length > 0) {
									var m = q.host.parents(".jqx-window").css(
											"z-index");
									b.css("z-index", m + 10);
						...
						renderSelection : function() {
							...
							if (r == null) {
								...
								var s = this.dropdownlistContent
										.css("padding-top");
								var v = this.dropdownlistContent
										.css("padding-bottom");
								j.css("padding-top", s);
								j.css("padding-bottom", v);
								var q = j.outerHeight();
								j.remove();
								j.removeClass();
								...
								var f = parseInt((parseInt(g) - parseInt(q)) / 2);
								if (f > 0) {
								...
								if (this.selectionRenderer) {
									a.jqx.utilities.html(
											this.dropdownlistContent, this
													.selectionRenderer(j, -1,
															"", ""));
									this.dropdownlistContent.css("margin-top",
											"0px");
									this.dropdownlistContent.css(
...
//							j[0].style.backgroundColor = "transparent";
							...
							j
									.addClass(this
											.toThemeProperty("jqx-widget jqx-listitem-state-normal jqx-item"));
							var p = false;
							try {
								if (r.html != undefined && r.html != null
							...
							var v = this.dropdownlistContent[0].style.paddingBottom;
							if (s === "") {
								s = "0px"
							}
							if (v === "") {
							...
							if (this.selectionRenderer) {
								a.jqx.utilities.html(this.dropdownlistContent,
										this.selectionRenderer(j, r.index,
												r.label, r.value));
								if (this.focusable && this.isOpened()) {
									this.focus()
								}
								...
								if (this.checkboxes) {
									...
									j.css("padding-bottom", 1 + parseInt(v));
									this.dropdownlistContent.html(j);
									if (this.focusable && this.isOpened()) {
										this.focus()
									}
								} else {
									var d = this.host.width() - this.arrowSize
											- 3;
									if (this.width && this.width !== "auto") {
										...
										j[0].style.paddingTop = (1 + parseInt(v))
												+ "px";
										if (!this.rtl) {
											if (c) {
							...
							var f = parseInt((parseInt(g) - parseInt(q)) / 2);
							if (f > 0) {
								this.dropdownlistContent[0].style.marginTop = f
										+ "px";
								this.dropdownlistContent[0].style.marginBottom = f
										+ "px"
							}
							if (this.selectionRenderer) {
						...
						getSelectedItem : function() {
							return this.listBox
									.getVisibleItem(this.selectedIndex)
						},
						...
						showListBox : function() {
							...
							if (this.dropDownWidth == "auto"
									&& this.width != null
									&& this.width.indexOf
									&& (this.width.indexOf("%") != -1 || this.width
											.indexOf("auto") != -1)) {
							...
							var k = parseInt(this._findPos(this.host[0])[1])
									...
									+ "px";
							var f, g = parseInt(Math.round(this.host
									.coord(true).left));
							f = g + "px";
						...
						_arrange : function() {
							...
							if (h.width && h.width.toString().indexOf("%") >= 0) {
								...
								h.dropdownlistContent[0].style.width = Math.abs(c) + "%"
							}
						...
						destroy : function() {
							...
							if (this.host.parents()) {
								this
										.removeHandler(this.host.parents(),
												"scroll.dropdownlist"
														+ this.element.id)
							}
							this.removeHandlers();
