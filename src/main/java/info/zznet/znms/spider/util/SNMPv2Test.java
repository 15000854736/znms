...
public class SNMPv2Test {  
    public static void main(String[] args) throws IOException, InterruptedException {  
        ...
        target.setAddress(new UdpAddress("10.40.255.254/161"));  
...
//        broadcastTarget.setAddress(new UdpAddress("10.40.255.254/161"));  
...
//        Thread.sleep(6000); //main thread wait 6s for the completion of asynchronous request   
    ...
    private static PDU createGetNextPdu() {  
        ...
        pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.4881.1.1.10.2.56.2.1.1.1.34")));   //sysUpTime  
        pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.4881.1.1.10.2.56.2.1.1.1.41")));   //sysName  
    ...
    private static PDU createGetBulkPdu() {  
        ...
        pdu.setMaxRepetitions(30);  //must set it, default is 0  
