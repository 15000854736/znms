		...
		<form id="graphForm" action="${pageContext.request.contextPath }/graph/addGraph" method="post">
			<table border="0" cellspacing="0" cellpadding="0"  class="nms_data_tablemod">
		        ...
		        <tr>
			          ...
			          <td>
			          	<input type="text" class="form-control input-sm" style="width:250px" name="graphName" id="graphName" maxlength="100" readonly="readonly" />
		  ...
		  <div class="mod_buttom_box">
			  <button type="button" class="btn btn-primary btn-xs" onclick="addGraph();">确定</button>
