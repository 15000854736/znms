    ...
    */
    ...
    GridStack.prototype._prepareElement = function(el, triggerAddEvent) {
        ...
        var node = self.grid.addNode({
        	moduleName: el.attr('data-gs-moduleName'),
            x: el.attr('data-gs-x'),
            y: el.attr('data-gs-y'),
    ...
    GridStack.prototype.addWidget = function(el,x, y, width, height,moduleName, autoPosition, minWidth, maxWidth,
        ...
        if (typeof moduleName  != 'undefined') { el.attr('data-gs-moduleName', moduleName); }
    ...
    GridStack.prototype.willItFit = function(x, y, width, height,moduleName, autoPosition) {
        var node = {x: x, y: y, width: width, height: height,moduleName: moduleName, autoPosition: autoPosition};
