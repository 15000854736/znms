...
<body>
		...
		<div class="znms_box">
			...
			<ul class="menu_mod_box">
			 <li id="1"><a href="${pageContext.request.contextPath }/thresholdValueAlarm">阀值触发日志</a></li>
			 <li id="2" class="tab_hov"><a href="#">阀值触发概况</a></li>
			 </ul>
			
			<!-- 表主体：start -->
			<s:table id="ZZOS_Common_Table" columns="阀值,最近一小时触发次数,最近一天触发次数,最近一周触发次数"
