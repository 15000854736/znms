...
<body>
		...
		<div class="znms_box">
			<p class="page_top_menu">系统管理&gt; <span class="bold">阀值管理</span></p>
		<!-- 头部菜单 end-->
	
		<!-- 表主体：start -->
		<s:table id="ZZOS_Common_Table" columns="阀值名称,主机,图形,流向,启用状态,警告高阀值,警告低阀值"
