...
<body>
		...
		<div class="znms_box">
			...
			<ul class="menu_mod_box">
			 <li id="1"  class="tab_hov"><a href="#">阀值触发日志</a></li>
			 <li id="2"><a href="${pageContext.request.contextPath }/thresholdValueAlarm/triggerSurvey">阀值触发概况</a></li>
			 </ul>
			
			<!-- 表主体：start -->
			<s:table id="ZZOS_Common_Table" columns="主机名,阀值,报警值,当前值,描述,时间"
