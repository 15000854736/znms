...
<body>
		...
		<!-- 表主体：start -->
		<s:table id="ZZOS_Common_Table" columns="${hostIp},${hostName},${status},${curTime },${avgTime },${availability }"
			ids="hostIp,hostName,status,curTime,avgTime,availability"
			dataUrl="${pageContext.request.contextPath }/host/search"
